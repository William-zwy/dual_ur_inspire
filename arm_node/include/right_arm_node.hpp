...
{
    public:
    explicit RightArm(const rclcpp::NodeOptions & node_options);
    ~RightArm() = default;
    ...
    geometry_msgs::msg::PoseStamped::SharedPtr right_pose_msg_;
    geometry_msgs::msg::PoseStamped::SharedPtr last_right_pose_msg_;
