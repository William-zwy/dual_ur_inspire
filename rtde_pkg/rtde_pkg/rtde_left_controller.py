...
class LeftCtrlNode(Node):
    ...
    def __init__(self,name):
        ...
        self.create_subscription(Float64MultiArray,'/ur_arm_left_ros2_controller/commands',self.command_callback,10)
        self.timer = self.create_timer(1.0/100,self.timer_callback)     
        self.rtde_c = RTDEControlInterface("192.168.1.40")
        
        init_cmd = [0.507,-1.26,1.65,-0.39,2.07,0.0]
        self.cmd = init_cmd
